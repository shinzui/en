...
- [ ] Record the index-retention and pruning coordination entries in the Decision Logs of `docs/plans/49` and `docs/plans/37` when the respective plans land (see Decision Log here).
